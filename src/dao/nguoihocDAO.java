...
public class nguoihocDAO extends edusysDAO<nguoihoc,String>{
    String INSERT_SQL="INSERT INTO NguoiHoc(maNguoiHoc,manguoihoc,hoTen,ngaySinh,gioiTinh,soDT,Email,ghiChu,ngayDangKy) VALUES(?,?,?,?,?,?,?,?,?)";
    ...
    public void update(nguoihoc entity) {
        jdbchelper.update(UPDATE_SQL,
                entity.getHoTen(),entity.getHoTen(),entity.getNgaySinh(),entity.getGioiTinh(),entity.getSoDT(),entity.getEmail(),entity.getGhiChu(),entity.getNgayDK(),entity.getMaNH());
    }
